...
// What we can do is we combined any of view to the keyboard so that when we click on the text box and the
// keyboard opens up we can say we can have it so that the the view will shift up with it.
